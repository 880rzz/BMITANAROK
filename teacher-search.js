...
function init(){
 ...
 sec.innerHTML='<div class="wrap"><div class="ts-head"><span class="eyebrow">Gyors kereső</span><h2>Milyen terület érdekel?</h2><p>Válassz egy területet. A találatoknál a tanár neve nyitja meg a teljes tanári profilt; alatta külön találod a kapcsolódó 2026/27-es foglalkozást, időpontot és helyszínt.</p></div><div class="ts-cats" role="list"></div><div class="ts-results" aria-live="polite"></div></div>';
